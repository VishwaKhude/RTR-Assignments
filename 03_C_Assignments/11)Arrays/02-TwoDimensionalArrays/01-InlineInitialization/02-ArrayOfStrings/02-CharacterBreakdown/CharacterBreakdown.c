...
int main(void)
{
    ...
    int iStrLengths[10]; //1D Integer Aarray - Stores lengths of those strins at corresponding indices in 'strArray[]' e.g.: iStrLengths[0] will be the length of string at strArray[0], iStringLengths[1] will be the length of string at strArray[1]...10 strings, 10 lengths...
    int strArray_size;
...
int MyStrlen(char str[])
{
    ...
    //code
    // *** DETERMINING EXACT LENGTH OF THE STRING, BY DETECTING THE FIRST OCCUREENCE OF NULL-TERMINATING CHARACTER ( \0 ) ***
