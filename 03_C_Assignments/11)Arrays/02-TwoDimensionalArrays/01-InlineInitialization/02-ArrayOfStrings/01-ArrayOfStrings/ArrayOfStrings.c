...
int main(void)
{
    ...
    printf("Number Of Rows (Strings) In Two Dimensional ( 2D ) Character (String Array) Is = %d \n\n", strArray_num_rows);

    strArray_num_columns = sizeof(strArray[0]) / char_size;
    printf("Number Of Columns In Two Dimensional ( 2D ) Character Aarray (String Array) Is = %d\n\n", strArray_num_columns);
