...
void MyStrrev(char str_destination[], char str_source[])
{
    ...
    // ARRAY INDICES BEGIN FROM 0, HENCE, LAST INDEX WILL ALWAYS WILL BE (LENGTH - 1)
    len = iStringLength - 1;

    // WE NEED TO PUT THE CHARACTER WHICH IS AT THE LAST INDEX OF 'str_source' TO THE FIRST INDEX OF 'str_destination'
