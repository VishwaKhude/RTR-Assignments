// *** THIS PROGRAM REPLACES ALL VOWELS INT THE INPUT STRING  WITH THE * (asterisk) SYMBOL ***
// *** FOR EXAMPLE, 'Dr. V*j*y D*tt*tr*y* G*kh*le *STR*M*D*C*MP'
...
int main(void)
{
    ...
    char chArray_Original[MAX_STRING_LENGTH], chArray_VowelsReplaced
