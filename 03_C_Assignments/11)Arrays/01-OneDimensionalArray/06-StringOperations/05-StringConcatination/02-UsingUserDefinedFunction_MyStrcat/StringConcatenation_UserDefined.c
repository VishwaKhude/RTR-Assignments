...
int main(void)
{
    ...
    printf("\n\n");
    printf("The Original First String Entered By You (i.e. : 'chArrray_One[]') Is : \n\n");
    printf("%s\n", chArray_One);
   ...
   return(0);
    ...
    void MyStrcat(char str_destination[], char str_source[])
    {
        ...
        // SO, CONCATENATION MUST BEGIN FROM INDEX NUMBER EQUAL TO LENGTH OF THR ARRAY 'str_destination'
