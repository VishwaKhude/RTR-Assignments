...
int main(void)
{
    ...
    float fArray[] = { 1.2f, 2.3f, 3.4f, 4.5f, 5.6f, 7.8f, 8.9f };
    int float_size;
    int fArray_size;
    ...
    // ***** cArray[] *****
    printf("\n\n");
    printf("In-line Initilization And Piece-meal Display Of Elements of Array 'cArray[]': \n\n");
