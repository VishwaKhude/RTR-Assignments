...
int main(void)
{
    ...
    // 'G' is 'char', but 'f' of 'data_three' is 'float'...hence, 'G' is converted to its decimal integer ASCII value (71) and this in turn is converted to 'float' (71.00000) and then it will be assigned to 'f' of 'data_three' 
    // 0.00000 will be assigned to 'd' of 'data_three'
    //No character will be assingned to 'c' of 'data_three'
    ...
    printf("\n\n");
    printf("DATA MEMBERS OF 'struct MyData_two' ARE: \n\n");
    printf("i = %d\n", data_two.i);
    printf("f = %f\n", data_two.f);
    printf("d = %lf\n", data_two.d);
    printf("c = %c\n", data_two.c);
    ...
    printf("\n\n");
    printf("DATA MEMBERS OF 'struct MyData_three' ARE: \n\n");
    printf("i = %d\n", data_three.i);
    printf("f = %f\n", data_three.f);
    printf("d = %lf\n", data_three.d);
    printf("c = %c\n", data_three.c);
    ...
    printf("\n\n");
    printf("DATA MEMBERS OF 'struct MyData_Four' ARE :\n\n");
    printf("i = %d\n", data_four.i);
    printf("f = %f\n", data_four.f);
    printf("d = %lf\n", data_four.d);
    printf("c = %c\n", data_four.c);
