...
int main(void)
{
    ...
    typedef unsigned int UINT; // UINT- 'Unsigned Integer'
    typedef UINT HANDLE; // HWND- 'Handle To Window'
    typedef HANDLE HWND;
    ...
    CHARACTER chArray_02[][10] = { "RTR", "Batch", "2023-24" };

    MY_DOUBLE d = 8.041997;

    // ****** JUST RANDOM NUMBERS = THEY HAVE NOTHING TO DO WITH ANY WINDOW' HANDLE OR INSTANCE HANDLE !!! This is just for understanding ******
    UINT uint = 3456;
    HANDLE handle = 987;
    HWND hwnd = 9876;
    ...
    //code
    printf("\n\n");
    printf("Type M_INT variable a = %d\n", a);
    ...
    printf("\n\n");
    printf("TypeMY_DOUBLE variable d = %lf\n", d);
    ...
    printf("Type HWND varible hwnd = %u\n\n", hwnd);
