...
int main(void)
{
    ...
    // *** HENCE, EACH OF THESE 5 ROWS THEMSELVES VEING ARRAYS, WILL BE THE BASE ADDRESSES OF THEIR RESPECTIVE ROWS ***
    printf("\n\n");
    ...
    if (ptr_iArray == NULL)
    {
        ...
        // *** FREEING MEMORY OF ptr_iArray WHICH IS THE ARRAY OF 5 INTEGER POINTERS... THAT IS, IT IS AN ARRAY HAVING 5 INTEGER ADDRESSES (TYPE int*) ***
        if (ptr_iArray)
        {
            free(ptr_iArray);
            ptr_iArray = NULL;
