...
int main(void)
{
    ...
    //Since, 'local_count' is a local static variable of chage_count(), it WILL retain its value from previous call to change_count().
    // So local_count is 1
    // local_count = local_count + 1 = 1 + 1 = 2
    change_count();

    // Since, 'local_count' is a local static variable of change_count(), it WILL retain it's value from previous call to change_count().
    // So, local_count is 2
