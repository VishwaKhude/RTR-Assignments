...
//If First Constant Is Not Assigned A Value, It I\Is Assumed To Be 0 i.e., 'SUNDAY' Will Be 0
//And Rest Of The Constants Are Assigned Consecutive Integer Values From 0 onwards i.e., MONDAY Will Be 2, and so on...
//Un-named enums
...
int main(void)
{
	...
	printf("Februrary Is Month Number = %d\n", FEBRUARY);
