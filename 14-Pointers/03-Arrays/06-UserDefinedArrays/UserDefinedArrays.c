...
int main(void)
{
    ...
    // **** INTEGER ARRAY ****
    printf("\n\n");
    printf("Enter Number Of Elements You Want In The Integer Array : ");
    ...
    {
        printf("\n\n");
        printf("MEMORY ALLOCATION FOR INTEGER ARRAY FALIED !!! EXITTING NOW... \n\n");
        exit(0);
    }
    else 
    {
    ...
    // **** DOUBLE ARRAY ****
    printf("\n\n");
    printf("Enter The Number Of Elements You Want In The 'doubleArray' : ");
    ...
    // ***** CHAR ARRAY *****
    printf("\n\n");
    printf("Enter Number Of Elements You Want In The Character  Array : ");
    ...
    {
        printf("\n\n");
        printf("MEMORY ALLOCATION FOR CHARACATER ARRAY SUCCEEDED !!!\n\n");
    }
