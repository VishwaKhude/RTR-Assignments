...
int main(void)
{
   ...
   //variable declaration
    ...
    //copt data from host arrays into device arrays
    ...
    char str[128];
    if (bAccuracy == false)
        sprintf(str, "Comparison of CPU and GPU Vector Addition is not within accuracy of 0.000001 at arraty index %d", breakValue);
    else
