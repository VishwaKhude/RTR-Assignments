...
int main(void)
{
    ...
    // set 0 based 2nd argument i.e. deviceOuput i.e. len
    ...
    size_t global_size = 5; // 1-D element array operation
    ...
    // read back result from the device (i.e from deviceOuptut) into cpu variable (i.e. hostOutput)
