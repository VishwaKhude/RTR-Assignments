...
int main(int argc, char *argv[])
{
    ...
    // create OpenCL kernel by passing kernel function name that wee used in .cl file
    ...
    if (result != CL_SUCCESS)
    {
        printf("clCreateKernel() failed for 1st Input Matrix : %d\n", result);
        cleanup();
        exit(EXIT_FAILURE);
    }
    ...
    // set 0 based 2nd argumnet i.e. deviceC
    ...
    // set 0 based 4th argument i.e. numAClumns
    ...
    // write above 'input device buffer t odevice moemory
