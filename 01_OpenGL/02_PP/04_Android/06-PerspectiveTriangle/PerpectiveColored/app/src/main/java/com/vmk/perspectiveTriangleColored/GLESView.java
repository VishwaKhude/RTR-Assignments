package com.vmk.perspectiveTriangleColored;
    ...
    private void initialize(GL10 gl)
    {
        ...
        if(shaderCompileStatus[0] == GLES32.GL_FALSE)
        {
            ...
            if(infoLogLength[0] > 0)
            {
                ...
                System.out.println("VMK: VertexShader Compilation error log :" + infolog);
                uninitialize();
                System.exit(0);
            }
        }
        ...
        if(shaderCompileStatus[0] == GLES32.GL_FALSE)
        {
            ...
            if(infoLogLength[0] > 0)
            {
                ...
                System.out.println("VMK: FragmentShader Compilation error log :" + infolog);
                uninitialize();
                System.exit(0);
            }
        }
        ...
        if(programLinkStatus[0] == GLES32.GL_FALSE)
        {
            ...
            if(infoLogLength[0] > 0)
            {
                ...
                System.out.println("VMK: Shader Program Link Compilation error log :" + infolog);
                uninitialize();
                System.exit(0);
            }
        }
