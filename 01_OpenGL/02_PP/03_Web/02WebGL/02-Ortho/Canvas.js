...
function resize()
{
    ...
    mat4.perspective(orthographicProjectionMatrix, 45.0, parseFloat(canvas.width) / parseFloat(canvas.height), 0.1, 100.0); 
...
function display()
{
    ...
    mat4.multiply(modelViewProjection, orthographicProjectionMatrix, modelViewMatrix);
