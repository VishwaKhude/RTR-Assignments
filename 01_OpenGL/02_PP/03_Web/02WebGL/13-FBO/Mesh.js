...
function Mesh()
{
    ...
    this.prepareToDraw=function()
    {
        ...
        gl.vertexAttribPointer(VertexAtrributEnum.AMC_ATTRIBUTE_POSITION,
                               3,
                               gl.FLOAT,
                               false,0,0);
        ...
        gl.bufferData(gl.ARRAY_BUFFER,
                      norms,
                      gl.STATIC_DRAW);
        gl.vertexAttribPointer(VertexAtrributEnum.AMC_ATTRIBUTE_NORMAL,
                               3,
                               gl.FLOAT,
                               false,0,0);
        ...
        gl.bufferData(gl.ARRAY_BUFFER,
                      texCoords,
                      gl.STATIC_DRAW);
        gl.vertexAttribPointer(VertexAtrributEnum.AMC_ATTRIBUTE_TEXCOORD,
