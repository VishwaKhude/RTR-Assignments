...
void draw(void)
{
	...
	rotationMatrix = vmath::rotate(fAngleTriangle, 0.0f, 1.0f, 0.0f);
	...
	//transformation matrix
	translationMatrix = vmath::translate(1.5f, 0.0f, -6.0f);
	rotationMatrix = vmath::rotate(fAngleSquare, 1.0f, 0.0f, 0.0f);
...
{
	//code
	fAngleTriangle = fAngleTriangle + 0.2f;
	if (fAngleTriangle <= 360.0f)
		fAngleTriangle = fAngleTriangle - 360.0f;

	fAngleSquare = fAngleSquare - 0.2f;
	if (fAngleSquare <= 0.2f)
		fAngleSquare = fAngleSquare + 360.0f;
}
